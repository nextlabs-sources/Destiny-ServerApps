...
// This is a new function that allows disabling the event handlers.
// It is called by the curtain div before showing itself.
function jscalendarPopUpCalendar_DisableClick()
{
	document.onclick = null;
	document.onkeypress = null;
}

//The content of this function was called inline before. Now it has been moved
//to a function to that the handlers can be enabled or disabled.
function jscalendarPopUpCalendar_EnableClick()
{
...
//Added to replace the inline calls
jscalendarPopUpCalendar_EnableClick()
