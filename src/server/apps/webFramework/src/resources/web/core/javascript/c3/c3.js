    ...
    c3.generate = function (config) {
        ...
        var __tooltip_show = getConfig(['tooltip', 'show'], true),
            ...
            for (i = 0; i < d.length; i++) {
                ...
                text += "<td class='name'><span style='background-color:" + color(d[i].id) + "'></span>" + getChartDisplayText(name) + "</td>";
...
*/
        ...
        function updateLegend(targetIds, options, transitions) {
            ...
            l.append('text')
                .text(function (id) { return isDefined(__data_names[id]) ? getChartDisplayText(__data_names[id]) : getChartDisplayText(id); })
            ...
            texts = legend.selectAll('text')
                .data(targetIds)
                .text(function (id) { return isDefined(__data_names[id]) ? getChartDisplayText(__data_names[id]) : getChartDisplayText(id); }) // MEMO: needed for update
                .each(function (id, i) { updatePositions(this, id, i === 0); });
