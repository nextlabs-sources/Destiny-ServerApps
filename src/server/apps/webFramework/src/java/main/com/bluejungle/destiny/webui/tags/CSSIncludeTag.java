...
/**
 * This is the css inclusion tag. The CSS inclusion tag allows inserting a CSS
 * stylesheet, and provides an abstraction layer for dynamic stylesheet
 * insertion.
 * 
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/apps/webFramework/src/java/main/com/bluejungle/destiny/webui/tags/CSSIncludeTag.java#1 $
 */

public class CSSIncludeTag extends UIComponentTag {

    protected static final String COMPONENT_TYPE = "com.bluejungle.destiny.CSSInclude";
