...
<f:view>
  ...
  <tiles:definition id="usersDefinition" extends="mgmtConsoleMainWithoutContentHeaderDefinition">
    <tiles:put name="applicationTitle" value="${bundle.mgmt_console_title}" />
    <tiles:put name="pageTitle" value="${bundle.users_and_roles_users_page_title}" />
    <tiles:put name="secondaryNav" value="/WEB-INF/jspf/tiles/usersandroles/usersAndRolesSecondaryNav.jspf" />
    <tiles:put name="content" value="/WEB-INF/jspf/tiles/usersandroles/usersContent.jspf" />
    <tiles:put name="helpURL"><h:outputText value="#{helpBundle.usermanagement_help_url}" /></tiles:put>
  </tiles:definition>

  <%-- Insert My Reports Definition --%>
  <f:subview id="usersDefinitionSubview">
    <tiles:insert beanName="usersDefinition" flush="false" />
  </f:subview>
