...
<f:view>
  ...
  <tiles:definition id="userGroupsBrowsePotentialMembersDefinition" extends="mgmtConsoleBrowseDataPickerDefinition">
    <tiles:put name="applicationTitle">
      <h:outputText value="#{bundle.mgmt_console_title}" />
    </tiles:put>
    <tiles:put name="pageTitle">
      <h:outputText value="#{bundle.users_and_roles_user_groups_browse_potential_members_page_title}" />
    </tiles:put>
    <tiles:put name="selectedItemBoxLabel">
      <h:outputText id="slctItmBoxLbl" value="#{bundle.users_and_roles_user_groups_browse_potential_members_selected_items_box_header}" />
    </tiles:put>
  ...
  <f:subview id="userGroupsBrowsePotentialMembersDefinitionSubview">
    <tiles:insert beanName="userGroupsBrowsePotentialMembersDefinition" flush="false" />
  </f:subview>    
