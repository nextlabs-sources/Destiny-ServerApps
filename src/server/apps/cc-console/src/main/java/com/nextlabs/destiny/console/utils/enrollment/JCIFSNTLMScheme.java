...
import com.nextlabs.destiny.console.exceptions.NTLMV2AuthException;
...
public class JCIFSNTLMScheme implements AuthScheme {
    ...
    public String authenticate(Credentials credentials, HttpMethod method) throws AuthenticationException {
        ...
        try {
            ...
            throw new InvalidCredentialsException(String.format("Credentials cannot be used for NTLM authentication: %s",
    ...
    public String authenticate(Credentials credentials, String method,
        ...
        throw new NTLMV2AuthException("Not implemented as it is deprecated anyway in Httpclient 3.x");
    }
    ...
    private class NTLM {
        ...
        private String generateType3Msg(String username, String password, String host,
            ...
            try {
                ...
                throw new NTLMV2AuthException("Invalid Type2 message", e);
            }
