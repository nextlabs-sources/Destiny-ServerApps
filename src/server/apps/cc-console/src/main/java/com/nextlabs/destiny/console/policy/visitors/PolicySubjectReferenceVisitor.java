...
/**
 *
 * Visitor to walk through Policy subject component references
 *
 * @author Amila Silva
 * @since 8.0
 *
 */
public class PolicySubjectReferenceVisitor extends DefaultPredicateVisitor {

    private LinkedList<PredicateData> predicates;
    private boolean skipNextOR = false;

    public PolicySubjectReferenceVisitor(LinkedList<PredicateData> predicates) {
    ...
    public List<PredicateData> getPredicates() {
        return predicates;
    }
