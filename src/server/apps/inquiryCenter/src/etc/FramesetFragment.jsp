...
<%
	...
	baseHref += request.getContextPath( ) + fragment.getJSPRootPath( );
       baseHref = WebUIEscapeUtils.escapeURL(baseHref);
%>
...
<HTML>
	<HEAD>
		<TITLE><%= StringEscapeUtils.escapeHtml(attributeBean.getReportTitle( )) %></TITLE>
		<BASE href="<%= baseHref %>" >
		...
		<script type="text/javascript">			
			...
			{
			%>
			var soapURL = "<%= WebUIEscapeUtils.escapeURL((String)request.getAttribute("SoapURL"))%>";
			<%
			}
			else
			{
