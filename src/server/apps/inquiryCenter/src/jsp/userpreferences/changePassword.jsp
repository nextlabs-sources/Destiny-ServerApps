...
<f:view>
  ...
  <tiles:definition id="changePasswordDefinition" extends="inquiryCenterMainDefinition">
	...
	<tiles:put name="helpURL"><h:outputText value="#{helpBundle.reporter_help_url}" /></tiles:put>
  </tiles:definition>
