...
/**
 * @author safdar
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/apps/inquiryCenter/src/java/main/com/bluejungle/destiny/inquirycenter/report/defaultimpl/datapickers/user/UserDisablingDataModel.java#1 $
 */

public class UserDisablingDataModel extends DisablingItemDataModel {
     ...
     */
    public UserDisablingDataModel(DataModel wrappedDataModel, ISelectedItemList selectedItems, String[] existingSelections) {
        ...
        if (existingSelections != null) {
            for (int i = 0; i < existingSelections.length; i++) {
                String qualifiedName = UserComponentEntityResolver.createUserQualification(existingSelections[i]);
